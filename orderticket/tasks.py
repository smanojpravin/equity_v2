...
#                        'TITAN','TORNTPHARM','TORNTPOWER','TRENT','TVSMOTOR','UBL','ULTRACEMCO','UPL','VOLTAS','WHIRLPOOL','WIPRO']
            ...
            fnolist = ["ZEEL","INDIACEM","INDUSTOWER","DELTACORP","HINDPETRO","POWERGRID","CANBK","ABFRL","BIOCON","VEDL","BSOFT","GRANULES","INDHOTEL","LICHSGFIN",
        "BANDHANBNK","BPCL","ZYDUSLIFE","AMBUJACEM","DLF","ITC","BALRAMCHIN","CHAMBLFERT","CROMPTON","ICICIPRULI","SBIN","SUNTV","WIPRO","GLENMARK","TATAMOTORS","HINDALCO",
        "IGL","JSWSTEEL","GNFC","UPL","DABUR","CHOLAFIN","GUJGASLTD","JINDALSTEL","JUBLFOOD","MARICO","AXISBANK","HDFCLIFE","LAURUSLABS","BERGEPAINT","AUROPHARMA","AUBANK",
        "BHARATFORG","CONCOR","GODREJCP","INTELLECT","SYNGENE","CANFINHOME","BHARTIARTL","TATACONSUM","IRCTC","AARTIIND","LUPIN","MGL","SBICARD","SBILIFE","COROMANDEL",
        "HCLTECH","ICICIBANK","SUNPHARMA","M&M","OBEROIRLTY","TVSMOTOR","CIPLA","IPCALAB","MFSL","ADANIPORTS","MCDOWELL-N","TECHM","VOLTAS","CUMMINSIND","SHRIRAMFIN","HDFCBANK",
        "MUTHOOTFIN","PEL","HAVELLS","TATACHEM","BAJAJFINSV","DALBHARAT","TATACOMM","TORNTPHARM","GRASIM","INDUSINDBK","GODREJPROP","ICICIGI","PVR","INFY","KOTAKBANK","MCX",
        "METROPOLIS","TRENT","UBL","SRF","TITAN","COLPAL","WHIRLPOOL","HDFC","BALKRISIND","HAL","HDFCAMC","HINDUNILVR","INDIGO","LT","POLYCAB","ASTRAL","BATAINDIA","ESCORTS",
        "MPHASIS","SIEMENS","ACC","BAJAJ-AUTO","DEEPAKNTR","PIDILITIND","ABB","LALPATHLAB","PIIND","ASIANPAINT","OFSS","BRITANNIA","LTTS","EICHERMOT","PERSISTENT","DIVISLAB",
        "COFORGE","INDIAMART","LTIM","NAVINFLUOR","APOLLOHOSP","DIXON","DRREDDY","NAUKRI","BAJFINANCE","MARUTI","ULTRACEMCO","BOSCHLTD","SHREECEM"]
